<template>
	<view class="tui-numberbox">
		<view class="tui-numbox-icon tui-icon-reduce"  :class="[disabled || min>=value?'tui-disabled':'']" @tap="reduce"
		 :style="{color:iconColor,fontSize:iconSize+'rpx',backgroundColor:backgroundColor,height:height+'rpx'}"></view>
		...
		<view class="tui-numbox-icon tui-icon-plus" :class="[disabled || value>=max?'tui-disabled':'']" @tap="plus" :style="{color:iconColor,fontSize:iconSize+'rpx',backgroundColor:backgroundColor,height:height+'rpx'}"></view>
	</view>
</template>
